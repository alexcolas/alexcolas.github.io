<div style="display: inline-block; width:600px; vertical-align: top; padding-bottom: 30px;">

<form id="formBTS" action="content/bts/generate_preview.php" method="post" target="preview" enctype="multipart/form-data">
    ...
    <button id="buttonPreviewBTS" class="button-secondary pure-button" form="formBTS" style="float:left;"><?php echo L::field_submit; ?></button>
...
<div style="display: inline-block; max-width:calc(80%-500px); min-width:500px;">
<iframe style="height: 900px; width: 100%; border: 0pt none; overflox: hidden;" name="preview" src="content/bts/empty_preview.php"/></iframe>
</div>
