...
class BTS
{
	...
	public function BTS()
	{
		...
		header('Content-Disposition: inline; filename="BTS.jpg"');

		$this->Resolutions = array(2310, 1611);

		$this->LayerBottom = imagecreatefromjpeg("static/.1.jpg");
		$this->LayerTest = imagecreatefromjpeg("static/test2.jpg");
	...
	public function Render($preview = true, $effect = 0)
	{
		...
		imagettftext($this->Source, 18.5, 0, 280, 692, $this->ColorGrey2, "fonts/CALISTB.TTF", "Serie ECONOMIQUE ET SOCIALE AVEC LA MENTION ASSEZ BIEN");
